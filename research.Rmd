...
### On-Going Projects
* Sparse signal detection via methods for combining p-values from independent tests. 
* Combining p-values via Box-Cox transformation.
* Power Calculation for single cell RNA sequenceing data.
